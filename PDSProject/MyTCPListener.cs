    ...
    public class MyTCPListener
    {
        ...
        public async Task ServeClientA ( Object result)
        {
            ...
            try
            {
                ...
                await MainWindow.main.textCheckConnection.Dispatcher.BeginInvoke(DispatcherPriority.Normal, new Action(() => { MainWindow.main.textCheckConnection.Text = "CONNENCTED"; }));
                await MainWindow.main.textCheckConnection.Dispatcher.BeginInvoke(
                ...
                if ((i = await stream.ReadAsync(bytes, 0, bytes.Length)) != 0)
                {
                    ...
                    //Da rivedere
                    await MainWindow.main.textCheckConnection.Dispatcher.BeginInvoke(DispatcherPriority.Normal, new Action(() => { MainWindow.main.textCheckConnection.Text = "NOT CONNENCTED"; }));
                    await MainWindow.main.textCheckConnection.Dispatcher.BeginInvoke(
                        DispatcherPriority.Normal, new Action(() => {
